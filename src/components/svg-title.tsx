...
const SvgTitle = () => {
    ...
    return (
        <div className="text-8xl flex items-center">
            <span className={`transition-all duration-1000 ease-in-out ${startAnimation ? 'translate-x-[-4.7rem] text-red-500 dark:text-indigo-400' : 'translate-x-0 dark:white'}`}>&lt;</span>
